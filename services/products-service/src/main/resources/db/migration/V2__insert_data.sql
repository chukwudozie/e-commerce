...
INSERT INTO public.product (id, available_quantity, description, name, price, category_id)
VALUES
    (nextval('product_seq'), 15, 'Curved O-LED gaming screen with 240Hz refresh rate', 'Curved O-LED Gaming Screen 1', 799.99, (SELECT id FROM category WHERE name = 'Screens')),
    (nextval('product_seq'), 18, 'Flat Q-LED monitor with 1440p resolution', 'Q-LED Monitor 1', 599.99, (SELECT id FROM category WHERE name = 'Screens')),
